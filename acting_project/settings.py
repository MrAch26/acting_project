"""
Django settings for acting_project project.
...
SECRET_KEY = 'luk9l(1_hx9#7y)o2ky=v&_eo$pg2e867ag%5^)+rizxwn973h'
...
ROOT_URLCONF = 'acting_project.urls'
...
WSGI_APPLICATION = 'acting_project.wsgi.application'
